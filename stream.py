...
st.write(""" 
   ...
   """)
st.write('This application will predict whether you have **diabetes or not**')
...
def input_features():
    ...
    glu = st.sidebar.slider('Glucose',20,300,50)
    ...
    data={'preg': preg,'glucose':glu,'bp':bp,'st':skint,'su':su,'bmi':bmi,'dpf':dpf,'age':age}
...
ev=input_features()
st.subheader("BELOW ARE THE PROVIDED INFORMATION")
st.write(ev)
##sc=StandardScaler()
...
if prediction == 1:
    ...
    st.write('Kudoos you **dont have diabetes**')
